...
$title = "Tambah User - SMK Negeri 1 Jakarta";
              ...
              <div class="row">
                <div class="col-8">
                  ...
                  <div class="mb-3 row">
                    ...
                    <label for="" class="col-sm-1 col-form-label">:</label>
                    <div class="col-sm-9" style="margin-left: -50px;">
                      <input type="text" class="form-control border-0 border-bottom" id="fullname" name="fullname"
                  ...
                  <div class="mb-3 row">
                    ...
                    <label for="" class="col-sm-1 col-form-label">:</label>
                    <div class="col-sm-9" style="margin-left: -50px;">
                      <textarea name="address" id="address" cols="30" rows="3" class="form-control" placeholder="address"
                        required></textarea>
                    </div>
                  </div>
                  <div class="mb-3 row">
