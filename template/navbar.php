<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?= $main_url ?>index.php">SMK Negeri 1 Jakarta</a>
        <!-- Sidebar Toggle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control border-0 bg-transparent"
                                                id="fullname" value=": <?= $profile['fullname'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="level" class="col-sm-3 col-form-label pe-0">Level</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control border-0 bg-transparent" id="level"
                                                value=": <?= $profile['level'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="address" class="col-sm-3 col-form-label pe-0">Alamat</label>
                                        <div class="col-sm-9">
