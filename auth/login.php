...
<head>
    ...
    <title>Login - SMK Negeri 1 Jakarta</title>
    <link href="<?= $main_url ?>asset/sb-admin/css/styles.css" rel="stylesheet" />
    <script src="https://use.fontawesome.com/releases/v6.1.0/js/all.js" crossorigin="anonymous"></script>
    <link rel="icon" type="image/x-icon" href="<?= $main_url ?>asset/image/smkn1-jakarta.png">
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Login - SMK Negeri 1 Jakarta</h3>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="text-muted small">Copyright &copy; SMK Negeri 1 Jakarta
                                        <?= date("Y") ?>
                                    </div>
                                </div>
                            </div>
